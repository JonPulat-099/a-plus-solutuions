    ...
    <div class="mx-6 py-10 text-center md:text-left">
      <div class="max-w-screen-xl mx-auto grid grid-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="">
          ...
          <p class="mb-4">
            <a href="javascript:void(0)" class="text-gray-600" @click="goTo('#our_services')">
              {{ $t('nav.services') }}
            </a>
          </p>
          <p class="mb-4">
            <a href="javascript:void(0)" class="text-gray-600" @click="goTo('#partners')"> {{ $t('nav.partners') }} </a>
          </p>
          <p>
            <a href="javascript:void(0)" class="text-gray-600" @click="goTo('#contacts')"> {{ $t('nav.contacts') }} </a>
          </p>
        </div>
        <div class="informations">
          ...
          <p class="flex items-center justify-center md:justify-start mb-4">
            ...
            <a href="mailto:info@a-plus.uz">info@a-plus.uz</a>
          </p>
          <p class="flex items-center justify-center md:justify-start mb-4">
            <svg
              aria-hidden="true"
            ...
            <a href="tel:996135848"> +998 99 613-58-48 </a>
          </p>
        </div>
      </div>
    </div>
